...
// Components
import { DetailProductCardSkeleton } from "../skeleton/ProductCardSkeleton";
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center">
        ...
        <Link
          ...
          className="truncate text-base font-semibold text-neutral-1"
        >
              ...
              {detailProductData?.promotion && (
                <p className="break-all text-base font-semibold text-alert-red">
                  <span className="mr-2 text-base font-normal text-neutral-3 line-through">
                    IDR{" "}
                    {Math.floor(
                      detailProductData?.price /
                        (1 - detailProductData?.promotion?.discount),
                    ).toLocaleString()}
                  </span>
